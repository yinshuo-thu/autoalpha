...
def mining_loop(
    ...
    prompt_version = str(cfg.get("AUTOALPHA_PROMPT_VERSION", "v2-diversity-20260424") or "v2-diversity-20260424")
    stale_cache_count = 0
    stale_cache_error = ""
    try:
    ...
    while True:
        ...
        model_lab_interval = int(cfg.get("AUTOALPHA_MODEL_LAB_INTERVAL_FACTORS", "30") or 30)
        if (
            model_lab_interval > 0
            and full_valid_count > 0
