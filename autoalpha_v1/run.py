#!/usr/bin/env python3
"""
autoalpha_v1/run.py — Entry point

Usage:
    python autoalpha_v1/run.py               # 3 ideas, full trading history
    python autoalpha_v1/run.py --n 5         # 5 ideas
    python autoalpha_v1/run.py --days 120    # use last 120 trading days
"""
