"""
autoalpha_v1/knowledge_base.py
...
def _copy_submit_artifact(run_id: str, entry: Dict[str, Any]) -> Dict[str, Any]:
    """Copy passing factor parquet into autoalpha_v1/submit and return metadata fields."""
...
def sync_submit_artifacts() -> Dict[str, Any]:
    """Backfill autoalpha_v1/submit with all currently passing parquet factors."""
    kb = _load()
    factors = kb.setdefault("factors", {})
    copied = 0
    skipped = 0
