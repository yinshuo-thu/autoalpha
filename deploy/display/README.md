# AutoAlpha v3 Display Deployment

This directory contains the read-only display server used by the public
AutoAlpha v3 snapshot site. It serves the built frontend plus precomputed JSON
...
```text
/Volumes/T7/autoalpha_v3_display/
  display_server.py
  start_display.sh
  frontend/dist/
  data/snapshots/
...
```bash
AUTOALPHA_DISPLAY_ROOT=/Volumes/T7/autoalpha_v3_display \
...
`/Volumes/T7/autoalpha_v3_display/start_display.sh`.
