...
ROOT="${AUTOALPHA_DISPLAY_ROOT:-/Volumes/T7/autoalpha_v3_display}"
...
mkdir -p "$HOME/Library/Logs/autoalpha_v3_display"
...
<dict>
  ...
  <string>${HOME}/Library/Logs/autoalpha_v3_display/display_server.out.log</string>
  <key>StandardErrorPath</key>
  <string>${HOME}/Library/Logs/autoalpha_v3_display/display_server.err.log</string>
</dict>
</plist>
PLIST
...
echo "Display server started on http://127.0.0.1:${AUTOALPHA_DISPLAY_PORT:-8080}/v3/"
