...
This script is intentionally conservative:
  ...
  - autoalpha_v3/submit is rebuilt with only factors that still pass the corrected gates.
"""
...
from autoalpha_v3.pipeline import AUTOALPHA_OUT, compute_alpha, evaluate_alpha, export_parquet
