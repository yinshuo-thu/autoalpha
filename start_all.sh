...
BACKEND_LABEL="com.autoalpha.v2.backend"
FRONTEND_LABEL="com.autoalpha.v2.frontend"
...
export AUTOALPHA_APP_BASE="${AUTOALPHA_APP_BASE:-/v2/}"
...
Starts the AutoAlpha v2 backend and frontend.
...
===========================================
AutoAlpha v2 services are running
Backend : ${BACKEND_URL}
