...
if __name__ == "__main__":
    print("Starting Complete No-Future-Function strategy with Optimizations...")
    ...
    create_trading_target_variable_no_future = optimizer.create_improved_target_variable
    ...
    # 运行策略（使用优化后的参数）
    results = strategy.run_full_strategy(
        max_symbols=15,  # 减少品种数
        look_ahead=3,     # 增加预测周期
        start_date='2015-01-01',  # 使用更近期数据
        end_date='2024-06-30',
        sample_rate=1.0
    )
